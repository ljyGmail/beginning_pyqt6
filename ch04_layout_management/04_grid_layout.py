...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        # Organize the right size widgets into columns 1 and 2
        # of the QGridLayout
    ...
    def loadWidgetValuesFromFile(self):
        ...
        try:
            with open('data/ch04/details.txt', 'r') as f:
                details = json.load(f)
            ...
            f = open('data/ch04/details.txt', 'w')
    ...
    def saveWidgetValues(self):
        ...
        with open('data/ch04/details.txt', 'w') as f:
