import sys
from PyQt6.QtWidgets import (QApplication, QWidget, QLabel, QLineEdit, QTextEdit,
                             QComboBox, QSpinBox, QDoubleSpinBox, QStackedLayout, QFormLayout, QVBoxLayout)
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        pixmap = QPixmap('data/ch04/norwegian.jpg')
        ...
        pg2_form.addRow(QLabel('Descrition'))
        default_text = """Have a long, sturdy body, long legs
            and a bushy ail. They are friendly, intelligent,
