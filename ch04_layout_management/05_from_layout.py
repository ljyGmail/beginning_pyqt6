...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        self.birthday_edit.setDisplayFormat('MM/dd/yyyy')
        ...
        regex = QRegularExpression(
            '\\b[A-Z0-9._%+-]+@[A-Z0-9.-]+\\.[com]{3}\\b', reg_opt.PatternOption.CaseInsensitiveOption)
        ...
        main_form.addRow('Date of Birth', self.birthday_edit)
    ...
    def checkFormInformation(self):
        ...
        if self.first_name_edit.text() == "" or \
            ...
            self.feedback_label.setText(
                '[INFO] Phone number enterd incorrectly.')
