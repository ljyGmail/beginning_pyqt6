...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        self.image_label.setPixmap(QPixmap('data/ch07/images/back.png'))
    ...
    def enterEvent(self, event):
        self.image_label.setPixmap(QPixmap('data/ch07/images/front.png'))
    ...
    def mouseDoubleClickEvent(self, event):
        self.image_label.setPixmap(QPixmap('data/ch07/images/boom.png'))
