...
class MainWindow(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter = QPainter()
        painter.begin(self)
        # Use anti-aliasing to smooth curved edges
    ...
    def drawDiffLines(self, painter):
        """Examples of how to draw l ines with QPainter."""
    ...
    def drawText(self, painter):
        """Example of ho to draw text with QPainter."""
    ...
    def drawRectangles(self, painter):
        ...
        # Demonstrate how t change the alpha channel
    ...
    def drawRoundedRects(self, painter):
        """Example of how to draw rectangles with
    ...
    def drawCircles(self, painter):
        ...
        painter.setBrush(brush)
        painter.drawEllipse(
            QPoint(int(center_x), int(center_y)), radius_x, radius_y)
