...
class Canvas(QLabel):
    ...
    def __init__(self, parent):
        ...
        # Keep track of the mouse of getting mouse coordinates
    ...
    def mouseReleaseEvent(self, event):
        ...
        Check when the eraser is no longer being used."""
        if event.button() == Qt.MouseButton.LeftButton:
            self.drawing = False
    ...
    def mouseMoveEvent(self, event):
        """Handle mouse movements. Track the coordinates of
        the mouse in the window and display them in the status
        bar."""
        mouse_pos = event.pos()
    ...
    def drawOnCanvas(self, points):
        ...
        if not self.eraser_selected:
            ...
            # Update the mouse's position fr next movement
    ...
    def paintEvent(self, event):
        ...
        This is to prevent the chance of the painting being
        lost if the user changes windows."""
...
class MainWindow(QMainWindow):
    ...
    def initializeUI(self):
        ...
        # Set a font style used by all tool tips
        QToolTip.setFont(QFont("Helvetica", 16))
    ...
    def createToolbar(self):
        ...
        color_act = QAction(
            QIcon("data/ch11/icons/colors.png"), "Colors", tool_bar)
