...
class MainWindow(QWidget):
    ...
    def closeEvent(self, event):
        ...
        if self.seq_group.start == running:
            self.seq_group.stop()
        event.accept()

    def startAnimations(self):
        """Play the animations and update the states of the 
        widgets."""
        ...
        self.button_anim.setKeyValueAt(0.5, QRect(
            QPoint(start_geometry.x() - 4, start_geometry.y() - 4),
