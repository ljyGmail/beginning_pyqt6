...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QMessageBox,
                             QTextEdit, QFileDialog, QInputDialog, QFontDialog, QColorDialog, QWidget)
...
class MainWindow(QMainWindow):
    ...
    def saveToFile(self):
        ...
        file_name, _ = QFileDialog.getSaveFileName(
            self, 'Save File', '', 'HTML Fiels (*.html);;Text Files (*.txt)')

        if file_name.endswith('.txt'):
            notepad_txt = self.text_edit.toPlainText()
    ...
    def searchText(self):
        ...
        if ok:
            extra_selections = []
            # Set the cursor th the beginning
    ...
    def aboutDialog(self):
        ...
        QMessageBox.about(
            self, 'About Notepad', """<p>Beginner's Practical Guide to PyQt</p><p>Project 5.1 - Note GUI</p>""")
