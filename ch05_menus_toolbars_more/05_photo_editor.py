...
class MainWindow(QMainWindow):
    ...
    def createToolsDockWidget(self):
        ...
        self.resize_half.setMaximumSize(QSize(130, 40))
    ...
    def createActions(self):
        ...
        self.print_act = QAction(QIcon('data/ch05/images/print.png'), 'Print')
        ...
        self.clear_act = QAction(
            QIcon('data/ch05/images/clear.png'), 'Clear Image')
    ...
    def openImage(self):
        """Open an image file and display its contents on
        the QLable Widget."""
    ...
    def printImage(self):
        """Print image and user QPrinter to select the
        ...
        if print_dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            # current viewport, whchi is the image_label
            ...
            # Scale image label to fit the rect source (0, 0)
    ...
    def rotateImage180(self):
        ...
        if self.image.isNull() == False:
            ...
            # the image, set the roated image as self.image
            self.image = QPixmap(rotated)
            self.image_label.repaint()  # Repaint the label

    def flipImageHorizontal(self):
        """Mirrow the image across the horizontal axis."""
        if self.image.isNull() == False:
