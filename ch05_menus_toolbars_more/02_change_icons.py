...
class MainWindow(QMainWindow):
    ...
    def initializeUI(self):
        ...
        self.setWindowIcon(QIcon('data/ch05/images/pyqt_logo.png'))
    ...
    def setUpMainWindow(self):
        ...
        self.images = [
            'data/ch05/images/1_apple.png', 'data/ch05/images/2_pineapple.png',
            'data/ch05/images/3_watermelon.png', 'data/ch05/images/4_banana.png'
        ]
    ...
    def changeButtonIcon(self):
        ...
        a different random icon form the images list."""
        self.icon_button.setIcon(QIcon(random.choice(self.images)))
        self.icon_button.setIconSize(QSize(60, 60))
