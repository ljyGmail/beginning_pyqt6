...
class MainWindow(QWidget):
    ...
    def createImageLabels(self):
        ...
        images = ['data/ch02/images/skyblue.png',
                  'data/ch02/images/profile_image.png']
        ...
        for image in images:
            try:
                ...
                if image == 'data/ch02/images/profile_image.png':
                    label.move(80, 20)
    ...
    def setUpMainWindow(self):
        ...
        about_label.setText(
            "I'm a Software Engineer with 10 years experience creating awesome code.")
        ...
        driver_date_label = QLabel(self)
        driver_date_label.setText('Aug 2015 - Dec 2017')
        driver_date_label.setFont(QFont('Arial', 7))
        driver_date_label.move(15, 370)
