...
from PyQt6.QtWidgets import (
    QApplication, QDialog, QLabel, QPushButton, QLineEdit, QMessageBox)
...
class NewUserDialog(QDialog):
    ...
    def setUpWindow(self):
        ...
        user_image = 'data/ch03/images/new_user_icon.png'
        ...
        # Create name QLable and QLineEdit widgets
    ...
    def confirmSignUp(self):
        ...
        if name_text == "" or pswd_text == "":
            ...
            QMessageBox.warning(self, 'Error Message', 'Please enter username or password values.',
            ...
            with open('data/ch03/files/users.txt', 'a+') as f:
                f.write("\n"+name_text+" ")
                f.write(pswd_text)
            self.close()
