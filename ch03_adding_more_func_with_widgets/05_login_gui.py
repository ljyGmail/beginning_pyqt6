...
from PyQt6.QtWidgets import (
    QApplication, QWidget, QLabel, QLineEdit, QPushButton, QCheckBox, QMessageBox)
...
class LoginWindow(QWidget):
    ...
    def setUpWindow(self):
        ...
        # Create sign up QLable and QPushButton
    ...
    def clickLoginButton(self):
        ...
        file = 'data/ch03/files/users.txt'
        ...
        try:
            ...
            # Collect username and password information
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        """Create and arrange widgets in the main window."""
        image = "data/ch03/images/background_kingfisher.jpg"
