...
from PyQt6.QtWidgets import (QApplication, QWidget, QLabel, QPushButton, QRadioButton,
                             QButtonGroup, QTabWidget, QGroupBox, QVBoxLayout, QHBoxLayout, QGridLayout)
...
class MainWindow(QWidget):
    ...
    def pizzaTab(self):
        ...
        pizza_image_path = 'data/ch06/images/pizza.png'
        ...
        toppings_list = ['Pepperoni', 'Sausage', 'Bacon', 'Canadian Bacon', 'Beef', 'Pineapple',
                         'Olive', 'Tomato', 'Green Pepper', 'Mushroom', 'Onion', 'Spinach', 'Cheese']
    ...
    def wingsTab(self):
        ...
        # Set up widgets and layouts to display information
        # to the user about the page
        tab_wings_label = QLabel('TRY YOUR AMAZING WINGS')
        tab_wings_label.setObjectName('Header')
        description_box = QWidget()
        description_box.setObjectName('ImageBorder')
        wings_image_path = 'data/ch06/images/wings.png'
